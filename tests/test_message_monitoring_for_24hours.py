...
def get_oauth_token():
    ...
    oauth_email = os.getenv("OAUTH_EMAIL")
    oauth_password = os.getenv("OAUTH_PASSWORD")
    oauth_client_id = os.getenv("OAUTH_CLIENT_ID")

    if not oauth_email or not oauth_password or not oauth_client_id:
        print("OAUTH_EMAIL, OAUTH_PASSWORD, or OAUTH_CLIENT_ID is missing; skipping OAuth token request.")
        return None
